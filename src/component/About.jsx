...
const AboutMe = ({ refs }) => {
		...
		>
			<div className="xl:w-[35%] flex flex-col gap-5">
				...
				<div className="flex flex-col gap-5 justify-center">
					...
					<a
						href="#contact"
						className="text-primaryTxt border-2 border-black w-fit px-2 py-2 rounded-2xl transition ease-in-out duration-300 hover:bg-[#f1faee] hover:text-[#212121] m-2"
					>
						Hire Me
					</a>
				</div>
    ...
    <img src="/dk2.jpg" alt="About Dk" className="rounded-2xl w-full" />
    {/* Half border styling */}
    <div className="absolute top-0 left-0 w-full h-full border-r-4 border-b-4 border-black rounded-2xl  m-4"></div>
</div>
